...
@SourceType(value = "ShipStationARP", label = "ShipStation",uiConfig = "shipstation-layout.json")
public class ShipStationConf extends AbstractArpConf<ShipStationConf> {
  private static final String ARP_FILENAME = "arp/implementation/shipstation-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.shipstation.ShipStationDriver";
